...
public final class DialogAddExpenseBinding implements ViewBinding {
  ...
  public static DialogAddExpenseBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new DialogAddExpenseBinding((ScrollView) rootView, btnRemovePhoto, btnTakePhoto,
          btnUploadPhoto, etAmount, etDate, etDescription, etType, framePhoto, ivExpensePhoto);
    }
